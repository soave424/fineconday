...
# Course information dictionary with complete tuples
course_info = {
...
if access_code == "z733":
    ...
    if data.empty:
        ...
        # Calculate the number of participants for each course
        ...
        # Add instructor, course code, and location with a complete fallback tuple
