...
# 강좌 정보 사전
course_info = {
    "경제교육보드게임, 캐쉬플로우": ("박민수쌤", "a0001", "7층 총회회의실"),
    "내 아이의 금융 문해력 기르기": ("댈님", "a0002", "7층 강의실A"),
    "창업과 투자 그리고 기업가정신까지!? 일석삼조 효과의 '어쩌다 초등 사장' 프로젝트": ("쭈니쌤", "a0003", "6층 강의실"),
    "왕초보도 따라하는 학급화폐 1년 로드맵": ("좋아유쌤", "a0004", "7층 강의실B"),
    "도구없이 누구나 할 수 있는 교육마술": ("이화수쌤", "a0005", "6층 중간 미팅룸"),
    "초등형 MBTI 클래시파이 : 웹개발스토리와 감정소진없이 학급경영하기": ("김태림쌤", "a0006", "6층 리더스홀"),
    "학교에서 시작하는 부수입 노하우": ("퇴근맨", "b0001", "미정"),
    "코로나 실전 투자 경험을 통해 배운 행복한 부자로 가는 길": ("노현진쌤", "b0002", "7층 강의실B"),
    "이렇게만 따라하세요! 20대 내 집 마련 루트": ("가드닝쌤", "b0003", "6층 리더스홀"),
    "내집마련 도전기: 꿈을 현실로 만드는 첫걸음": ("먹태쌤", "b0004", "6층 강의실"),
    "은또링샘의 친절한 재무제표 분석 (feat. 미리 캔버스)": ("은또링쌤", "b0005", "7층 강의실A"),
    "교사를 위한 퍼스널 브랜딩 & 꼬꼬무 부수입": ("진격의홍쌤", "c0001", "6층 리더스홀"),
    "미친 자에게 건배를: 부동산 투자에 미친 자의 이야기": ("다니쌤", "c0002", "7층 강의실A"),
    "부린이도 할 수 있다! 같은 돈으로 더 오르는 내집 마련 A to Z": ("홍당무쌤", "c0003", "7층 강의실B"),
    "소비형 인간에서 저축형 인간 마인드셋하기": ("따롱쌤", "c0004", "6층 강의실"),
    "선생님의 돈공부: 재무관리와 내 삶 기획하기": ("달구쌤", "c0005", "7층 총회회의실")
}
...
if st.session_state.is_logged_in and st.session_state.user_type == "강사":
    ...
    selected_course = None
    for course, (instructor, code, room) in course_info.items():
        if code == entered_code:
            selected_course = course
            course_instructor, course_code, _ = course_info[selected_course]
            display_course_name = f"{selected_course} ({instructor} - {room})"
            break
